...
def setSettings():
	...
	if "fastbotArgs" in data.keys():
		if "staticIPAddress" in data["fastbotArgs"].keys(): s.set(["fastbotArgs", "staticIPAddress"], data["fastbotArgs"]["staticIPAddress"])
		if "staticIPNetmask" in data["fastbotArgs"].keys(): s.set(["fastbotArgs", "staticIPNetmask"], data["fastbotArgs"]["staticIPNetmask"])
		if "staticIPGateWay" in data["fastbotArgs"].keys(): s.set(["fastbotArgs", "staticIPGateWay"], data["fastbotArgs"]["staticIPGateWay"])
