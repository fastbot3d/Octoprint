$(function() {
    function PluginManagerViewModel(parameters) {
        ...
        self.enableToggle = function(data) {
            return self.enableManagement() && (data.key != 'pluginmanager'  &&  data.key != "fastbot_printer" 
           &&  data.key != "touchui"  ); //lkj
        };
        ...
        self.togglePlugin = function(data) {
            ...
            if (data.key == "pluginmanager" ||  data.key == "fastbot_printer") return; //lkj
