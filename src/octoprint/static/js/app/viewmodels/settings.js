$(function() {
    function SettingsViewModel(parameters) {
        ...
        self.printerState = parameters[3]; //lkj
        ...
        self.fromResponse = function(response) {
            ...
            self.server_diskspace_warning(response.server.diskspace.warning);
            self.server_diskspace_critical(response.server.diskspace.critical);
    ...
    OCTOPRINT_VIEWMODELS.push([
        SettingsViewModel,
        //lkj ["loginStateViewModel", "usersViewModel", "printerProfilesViewModel"],
