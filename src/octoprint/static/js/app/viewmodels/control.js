$(function() {
    function ControlViewModel(parameters) {
        ...
        self.sendJogCommand = function (axis, multiplier, distance) {
            ...
            /*lkj if (self.settings.printerProfiles.currentProfileData() && self.settings.printerProfiles.currentProfileData()["axes"] && self.settings.printerProfiles.currentProfileData()["axes"][axis] && self.settings.printerProfiles.currentProfileData()["axes"][axis]["inverted"]()) {
                multiplier *= -1;
            }*/
            
            //lkj add
            var xySpeed =  $("#jog_distance_xy_speed_input").val();        
            var zSpeed =  $("#jog_distance_z_speed_input").val();   
            var speedTarget = 10;
            if (axis == 'x' || axis == 'y') {
                speedTarget = xySpeed;
            } else if (axis == 'z'){
            ...
            if ((distance !=0.1) && (distance !=1) && (distance !=10) && (distance !=100) ){
                distance = 10;
            }
            var data = {
                "command": "jog"
        ...
        self._sendECommand = function (dir) {
            ...
            //lkj add
            var eSpeed =  $("#jog_distance_e_speed_input").val();
        ...
        self.sendFanCommand = function(on, fan_id) {
            if (typeof fan_id === "undefined")
                id = $('#fan_group button.active').data('distance');
            //alert("id:" + id + "on:" + on );
            var data = {
                "command": "fastbot"
            };
